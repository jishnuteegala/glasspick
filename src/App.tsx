...
export default function App() {
  ...
  return <div className="flex min-h-screen flex-col"><a className="skip-link" href="#main-content">Skip to main content</a><header className="border-b border-line bg-surface">
    <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-4 sm:px-6"><div className="flex items-center gap-2.5"><span aria-hidden="true" className="flex size-8 items-center justify-center rounded-md bg-primary text-sm font-bold text-white shadow-panel">G</span><div className="leading-tight"><strong className="block">GlassPick</strong><span className="text-xs text-muted">provably fair winner picker</span></div></div><a className="text-sm text-muted hover:text-ink" href="https://github.com/jishnuteegala/glasspick">Source</a></div>
